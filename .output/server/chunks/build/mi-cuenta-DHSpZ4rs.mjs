...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></div><div class="mt-4"><label class="flex items-center text-sm"><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(check.value) ? ssrLooseContain(check.value, null) : check.value) ? " checked" : ""} required class="mr-2"><span> Autorizo el <a target="_blank" href="https://storage.googleapis.com/static-content-seed/celima/personales.pdf" class="underline ml-1" title="Ver documento"> uso de datos </a> y env\xEDo de comunicaci\xF3n por correo electr\xF3nico y celular </span></label></div><div class="mt-4"><label class="flex items-center text-sm"><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(user.value.terms) ? ssrLooseContain(user.value.terms, null) : user.value.terms) ? " checked" : ""} required class="mr-2"><span> Acepto <a target="_blank" href="https://storage.googleapis.com/static-content-seed/danec/terms.pdf" class="underline ml-1" title="Ver documento"> T\xE9rminos y Condiciones </a></span></label></div><div class="mt-6 text-center"><button class="bg-primary_color text-white px-6 py-2 rounded">${ssrInterpolate(filled.value ? "Actualizar" : "Actualizar y continuar")}</button></div></div></div></div>`);
      if (dialog.value) {
...
//# sourceMappingURL=mi-cuenta-DHSpZ4rs.mjs.map
