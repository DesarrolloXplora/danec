...
import { mergeProps, withCtx, createVNode, useSSRContext, withAsyncContext, createTextVNode, unref } from "vue";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p class="btn my-4" data-v-b33ffc58${_scopeId}>Ver más</p>`);
          } else {
            return [
              createVNode("p", { class: "btn my-4" }, "Ver más")
            ];
          }
        }),
        _: 1
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_Title, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`Programa | Catálogo`);
                } else {
                  return [
                    createTextVNode("Programa | Catálogo")
                  ];
                }
              }),
              _: 1
...
//# sourceMappingURL=index-0tv5XZid.js.map
